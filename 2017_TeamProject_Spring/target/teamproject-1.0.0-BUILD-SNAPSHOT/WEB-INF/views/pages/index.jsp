    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${ pageContext.request.contextPath }/pages/home.do">인강사이트</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 어학<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="${ pageContext.request.contextPath }/pages/toeic.do">토익</a>
                                </li>
                                <li>
                                    <a href="#">토플</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> 회원 <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">회원가입</a>
                                </li>
                                <li>
                                    <a href="${ pageContext.request.contextPath }/pages/login_form.do">로그인</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
