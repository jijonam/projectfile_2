...
<table width="750" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<input name="subject" type="text" class="search" style="width:250px;" value="${vo.subject}"></td>
		
	</tr>
	<tr>
		<td height="25" class="td_d_4">작성자</td>
		<td class="td_d_2" colspan="3">
		<input name="name" type="text" class="search" style="width:250px;" value="${vo.name}">
		</td>
	</tr>
    ...
    <tr>
		...
		<input name="pwd" type="password" class="search" style="width:70px;" value="${vo.pwd}"></td>
	</tr>        
